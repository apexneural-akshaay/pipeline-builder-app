...
# based on version + task + size and writes it into D:/APEXNEURAL TRAIL/V/Vision-Project/visionai-platform/pipeline-builder-app/backend/models/yolo26n-pose.pt.
model_node_3 = YOLO("D:/APEXNEURAL TRAIL/V/Vision-Project/visionai-platform/pipeline-builder-app/backend/models/yolo26n-pose.pt")
TASK_node_3 = "pose"
TRACKING_node_3 = True              # True to use model.track(), False for model()
CLASSES_node_3 = ["person"]                # list of class names to keep; empty list = all
