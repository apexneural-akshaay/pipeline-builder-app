...
CLASSES_node_2 = ["backpack","handbag","suitcase","person"]                # list of class names to keep; empty list = all
...
CLIP_SECONDS_node_3    = int("9")
CLIP_FPS_node_3        = int("9")
...
clip_meta_node_3 = deque(maxlen=CLIP_FPS_node_3 * CLIP_SECONDS_node_3)
        ...
        if now - _last_fire_node_3 >= COOLDOWN_S_node_3:
            ...
            if SAVE_CLIP_node_3:
                ...
                meta_doc = {
                    ...
                    "frame_count": len(buffer_node_3),
                    "frames": list(clip_meta_node_3),
                }
