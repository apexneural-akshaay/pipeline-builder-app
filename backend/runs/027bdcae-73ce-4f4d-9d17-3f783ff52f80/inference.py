...
cap_node_1 = cv2.VideoCapture("D:/APEXNEURAL TRAIL/V/Vision-Project/visionai-platform/pipeline-builder-app/backend/uploads/1779173670100_cctv.mp4")
if not cap_node_1.isOpened():
    raise RuntimeError("Failed to open source: D:/APEXNEURAL TRAIL/V/Vision-Project/visionai-platform/pipeline-builder-app/backend/uploads/1779173670100_cctv.mp4")
...
if not ok_first_node_1:
    raise RuntimeError("Source opened but produced no frames: D:/APEXNEURAL TRAIL/V/Vision-Project/visionai-platform/pipeline-builder-app/backend/uploads/1779173670100_cctv.mp4")
...
COND_MIN_CONF_node_3 = float("0.1")

# ── event_sink (node-4) ──
EVENTS_DIR_node_4 = "/event"
SAVE_SCREENSHOT_node_4 = False    # "True" / "False" injected by assembler
SAVE_CLIP_node_4       = True
CLIP_SECONDS_node_4    = int("10")
CLIP_FPS_node_4        = int("15")
COOLDOWN_S_node_4      = float("2")
...
while True:
    ...
    if not ok_node_1:
        ...
        if "D:/APEXNEURAL TRAIL/V/Vision-Project/visionai-platform/pipeline-builder-app/backend/uploads/1779173670100_cctv.mp4".startswith("rtsp://"):
            time.sleep(0.5)
            continue
        break
