...
COOLDOWN_S_node_3      = float("5")

# Split the clip into half-pre / half-post so the trigger sits roughly in the middle.
_pre_n_node_3  = (CLIP_FPS_node_3 * CLIP_SECONDS_node_3) // 2
_post_n_node_3 = (CLIP_FPS_node_3 * CLIP_SECONDS_node_3) - _pre_n_node_3
...
buffer_node_3 = deque(maxlen=_pre_n_node_3)
clip_meta_node_3 = deque(maxlen=_pre_n_node_3)
    ...
    if upstream["detections"]:
        ...
        if now - _last_fire_node_3 >= COOLDOWN_S_node_3:
            ...
            if SAVE_CLIP_node_3:
                ...
                writer = _try_h264_writer_node_3(clip_path, CLIP_FPS_node_3, w, h)
