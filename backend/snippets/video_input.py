...
state["{{node_id}}"] = {"frame": first_{{node_id}}, "width": SRC_W_{{node_id}}, "height": SRC_H_{{node_id}}, "fps": TARGET_FPS_{{node_id}}}
...
if _frame_idx_{{node_id}} % FRAME_STRIDE_{{node_id}} != 0:
    continue
state["{{node_id}}"] = {"frame": frame_{{node_id}}, "width": SRC_W_{{node_id}}, "height": SRC_H_{{node_id}}, "fps": TARGET_FPS_{{node_id}}}
_emitted_{{node_id}} += 1
